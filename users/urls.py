...
from .views import home, profile, RegisterView, wallet, clear_balance_changes, balance_changes, clear_categories, \
    charts, edit_balance_change, delete_balance_change, export_balance_changes
...
urlpatterns = [
    ...
    path('export_balance_changes/', export_balance_changes, name='users-export_balance_changes'),
